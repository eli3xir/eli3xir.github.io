...
tags:
  ...
  - 多线程
  - MySQL
description: 项目过程实录：用C++语言实现的聊天室，主要在linux环境下进行测试，采用多线程并发，利用MySQL数据库对用户信息进行存储。
abbrlink: 50706
date: 2021-06-25 06:44:01
---

### 服务器和客户端进行简单的TCP通信

- 没学过计算机网络，或想复习传输层基本概念，请看[附录一](#附录一 传输层的基本概念)
- 没有接触过 Socket 编程，或想复习 TCP 网络编程，请看[附录二](#附录二 用C++进行TCP套接字网络编程 )
...
>
> ![图片描述](/assets/img/dd8de37937e5.jpg)
>
> #### 传输层的作用
>
...
> TCP 的报头如下图所示。
>
> ![图片描述](/assets/img/0b2749e48e0a.jpg)
>
> 重点关注几个标志位的意义，如下：
>
> ![图片描述](/assets/img/be8b8b35d04d.jpg)
>
...
>
> ![图片描述](/assets/img/7f51e52e6eb2.jpg)
...
> 过程如下：
>
> ![图片描述](/assets/img/2b3c9899686e.jpg)
>
> #### TCP 网络编程的客户端
>
...
> 过程如下：
>
> ![图片描述](/assets/img/c0b15ec13a1e.png)
>
> #### 完整流程
>
> TCP 网络编程的整体流程如下图所示：
>
> ![图片描述](/assets/img/f09b7c4b3fc5.jpg)
>
> #### TCP 网络编程的相关数据结构
>
> 地址结构：
